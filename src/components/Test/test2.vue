<template>
  <div >
    <div class="result-item__citation">
      <div class="citation-heading">搜索结果</div>
      <!-- TODO 这里之后可以考虑改为形如 May 20, 2022 的形式 -->
      <div class="citation-date">{{ item.id}}</div>
    </div>
...
<!--      &lt;!&ndash; 论文的信息：来源（期刊会议）host_venue、发行日期、类型、doi网址 &ndash;&gt;-->
<!--      <div class="card-simple-info" v-if="notInCollection">-->
<!--        &lt;!&ndash; 跳转到对应的host_venue主页 &ndash;&gt;-->
<!--        <span-->
...
<!--        </span>-->
<!--        &lt;!&ndash; 这里由于伪元素位置的影响，必须span里面嵌套一个span &ndash;&gt;-->
...
<!--      &lt;!&ndash; 论文的领域concepts气泡展示，这里只截取前11个 &ndash;&gt;-->
<!--      <div class="card-concepts clearfix" v-if="notInCollection">-->
<!--        &lt;!&ndash; 跳转到对应的concept主页 &ndash;&gt;-->
<!--        <div-->
...
<!--      &lt;!&ndash; 论文底部简略信息和快捷操作 &ndash;&gt;-->
<!--      <div class="card-footer clearfix">-->
<!--        &lt;!&ndash; 论文底部简略信息 &ndash;&gt;-->
